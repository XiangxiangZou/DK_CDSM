...
def main():
    ...
    #
    #   落盘文件 (都位于 mj_sim_log/<program>/<program>_<timestamp>/, basename 同名):
    ...
    #
    #   另: GIF 同时复制一份到 utils_plot.get_save_dir() 的 Figs 目录, 命名为
    ...
    # get_save_dir() 返回 "Figs/<program>/<timestamp>"; 从路径直接拆出两级名字,
