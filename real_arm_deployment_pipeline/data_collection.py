...
try:
    from .cable_mapping import CABLE_NAMES, F_MAX_CABLE, F_PRELOAD, cable_antagonistic_map
    from .mujoco_plant import CONTROL_DIM, STATE_DIM, MujocoCablePlant
...
def _safe_q_limits(plant: MujocoCablePlant, ratio: float) -> np.ndarray:
...
def _tau_to_cable(plant: MujocoCablePlant, tau: np.ndarray, cfg: CollectionConfig) -> np.ndarray:
