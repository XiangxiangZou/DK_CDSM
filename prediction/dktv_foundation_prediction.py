...
from traj_data.dktv_data import (  # noqa: E402
    assess_data_quality,
...
from prediction.dktv.config import load_foundation_config  # noqa: E402
from prediction.dktv.foundation import (  # noqa: E402
...
DEFAULT_CONFIG = PROJECT_ROOT / "prediction" / "dktv_base_config.json"
PROVENANCE_FILES = (
    "AGENTS.md",
    "docs/dktv/plans/DKTV_PLAN_01_FOUNDATION.md",
    "docs/dktv/reviews/DKTV_PLAN_01_REVIEW.md",
...
def execute(args: argparse.Namespace) -> dict[str, Any]:
    ...
    invocation = {
        "entry_module": "prediction.dktv_foundation_prediction",
        "argv": [sys.executable, "-m", "prediction.dktv_foundation_prediction", *sys.argv[1:]],
