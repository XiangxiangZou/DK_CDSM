...
outputs/
  data/deployment_pipeline/
  models/deployment_pipeline/
...
run_01_collect_data.py
  ...
  -> outputs/data/deployment_pipeline/raw/*.npz
...
run_04_tracking_compare.py
  ...
  -> outputs/results/deployment_pipeline/tracking/*
...
run_05_cartesian_ik_tracking_compare.py
  ...
  -> outputs/results/deployment_pipeline/cartesian_tracking/*
...
run_06_render_mujoco_animation.py
  -> outputs/results/deployment_pipeline/cartesian_tracking/<run>/<trajectory>/closed_loop_<model>.npz
  -> mujoco_plant.MujocoCablePlant
  -> mujoco.Renderer
  -> outputs/results/deployment_pipeline/cartesian_tracking/<run>/<trajectory>/animations/*.gif
  - 动画中白色虚线表示期望末端轨迹，红色实线表示该方法的真实末端运动轨迹。

run_08_render_combined_mujoco_trajectory_gif.py
  -> outputs/results/deployment_pipeline/cartesian_tracking/<run>/<trajectory>/cartesian_ik_reference.npz
  -> outputs/results/deployment_pipeline/cartesian_tracking/<run>/<trajectory>/closed_loop_edmd.npz
  -> outputs/results/deployment_pipeline/cartesian_tracking/<run>/<trajectory>/closed_loop_dkuc.npz
  -> outputs/results/deployment_pipeline/cartesian_tracking/<run>/<trajectory>/closed_loop_dkac.npz
  -> mujoco_plant.MujocoCablePlant
  -> mujoco.Renderer
  -> outputs/results/deployment_pipeline/cartesian_tracking/<run>/<trajectory>/animations/*combined*.gif
